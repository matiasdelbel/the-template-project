...
@Composable
fun CreateWaterScreen(
    viewModel: CreateWaterViewModel,
    onClose: () -> Unit,
    ...
    DurationOutlinedTextField(
        field = viewModel.litersInputFieldState,
    ...
    AveragePaceOutlinedTextField(
        field = viewModel.dateInputFieldState,
...
private fun WaterCard(
    ...
    val date by remember {
        derivedStateOf { viewModel.dateInputFieldState.text.ifBlank { "00:00" } }
    }

    val liters by remember {
        derivedStateOf { viewModel.litersInputFieldState.text.ifBlank { "00:00" } }
    }
